...
function createBaseAssetRegistryEntryV1(): AssetRegistryEntryV1 {
  return {
    canonicalDenom: "",
...
export const AssetRegistryEntryV1 = {
  ...
  encode(message: AssetRegistryEntryV1, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
...
function createBasePrivacyScanCursorV1(): PrivacyScanCursorV1 {
  return {
    height: BigInt(0),
...
export const PrivacyScanCursorV1 = {
  ...
  encode(message: PrivacyScanCursorV1, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
...
function createBasePrivacyEventAttributeV1(): PrivacyEventAttributeV1 {
  return {
    key: "",
    value: ""
  };
...
export const PrivacyEventAttributeV1 = {
  ...
  encode(message: PrivacyEventAttributeV1, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.key !== "") {
...
function createBasePrivacyEventRecordV1(): PrivacyEventRecordV1 {
  return {
    globalSequence: BigInt(0),
    height: BigInt(0),
...
export const PrivacyEventRecordV1 = {
  ...
  encode(message: PrivacyEventRecordV1, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.globalSequence !== BigInt(0)) {
...
function createBasePrivacyScanSummaryV2(): PrivacyScanSummaryV2 {
  return {
    globalSequence: BigInt(0),
    height: BigInt(0),
    txHash: new Uint8Array(),
...
export const PrivacyScanSummaryV2 = {
  ...
  encode(message: PrivacyScanSummaryV2, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.globalSequence !== BigInt(0)) {
      writer.uint32(8).uint64(message.globalSequence);
    }
    if (message.height !== BigInt(0)) {
...
function createBasePrivacyScanOutputV2(): PrivacyScanOutputV2 {
  return {
    globalSequence: BigInt(0),
    height: BigInt(0),
    outputIndex: 0,
...
export const PrivacyScanOutputV2 = {
  ...
  encode(message: PrivacyScanOutputV2, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.globalSequence !== BigInt(0)) {
      writer.uint32(8).uint64(message.globalSequence);
    }
    if (message.height !== BigInt(0)) {
...
function createBaseMerkleRootSnapshotV1(): MerkleRootSnapshotV1 {
  return {
    root: new Uint8Array(),
    leafCount: BigInt(0),
    height: BigInt(0)
...
export const MerkleRootSnapshotV1 = {
  ...
  encode(message: MerkleRootSnapshotV1, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
...
function createBaseReserveBalanceV1(): ReserveBalanceV1 {
  return {
    canonicalDenom: "",
    totalDeposited: "",
    totalWithdrawn: ""
...
export const ReserveBalanceV1 = {
  ...
  encode(message: ReserveBalanceV1, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.canonicalDenom !== "") {
      writer.uint32(10).string(message.canonicalDenom);
    }
...
function createBaseCircuitIdentity(): CircuitIdentity {
  return {
    circuitId: "",
    verifyingKeySha256: "",
...
export const CircuitIdentity = {
  ...
  encode(message: CircuitIdentity, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
...
function createBaseCircuitSetIdentity(): CircuitSetIdentity {
  return {
    schemaVersion: "",
    circuitSetId: "",
    curve: "",
...
export const CircuitSetIdentity = {
  ...
  encode(message: CircuitSetIdentity, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
